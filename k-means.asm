...
.data
    ...
    # Input D
    #n_points:    .word 30
    #points:      .word 16,1, 14,2, 18,6, 20,3, 21,1, 17,4, 21,7, 16,4, 21,6, 19,6, 4,24, 6,24, 8,23, 6,26, 6,26, 6,23, 8,25, 7,26, 7,20, 4,21, 4,10, 2,10, 3,11, 2,12, 4,13, 4,9, 4,9, 3,8, 0,10, 4,10

    # Input E
    # n_points:    .word 35
    # points:      .word 16,1, 14,2, 18,6, 20,3, 21,1, 17,4, 21,7, 16,4, 21,6, 19,6, 4,24, 6,24, 8,23, 6,26, 6,26, 6,23, 8,25, 7,26, 7,20, 4,21, 4,10, 2,10, 3,11, 2,12, 4,13, 4,9, 4,9, 3,8, 0,10, 4,10, 20,22, 21,27, 22,25, 25,29, 28,21

    # Valores de centroids e k para mainSingleCluster:
    # centroids:   .word 0,10
    # k:           .word 1

    # Valores de centroids, k e L para mainKMeans:
    centroids:   .word 0,0, 10,0, 0,10
    k:           .word 3
    L:           .word 120
    oldCentroids:.word 0,0, 10,0, 0,10      # Igual a centroids, sera depois atualizado

    clusters:    .zero 4*23                 # 4* n_points
